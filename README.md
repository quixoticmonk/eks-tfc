...
| Name | Type |
|------|------|
| [aws_eks_addon.newrelic_addon](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eks_addon) | resource |
...
| [aws_eks_addon_version.nr](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/eks_addon_version) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_k8s_admin_role_arn"></a> [k8s\_admin\_role\_arn](#input\_k8s\_admin\_role\_arn) | Role arn to be provided cluster admin access | `string` | n/a | yes |
| <a name="input_cluster_version"></a> [cluster\_version](#input\_cluster\_version) | K8s version | `string` | `"1.28"` | no |
